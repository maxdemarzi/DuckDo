...
698 assertions across 26 test files, with three further files that run only when
`DUCKDO_MODEL_DIR` points at exported weights. They cover estimator recovery, diagnostics, error paths, guardrails, graph identification, mediation,
