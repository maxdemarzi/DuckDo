...
1. **Continuous and multi-valued treatments** — dose-response curves. The single most-requested gap in the current CFM literature, and the most common real-world shape.
